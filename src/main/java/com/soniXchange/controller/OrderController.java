...
import com.soniXchange.request.CreateOrderRequest;
...
public class OrderController {
    ...
    public ResponseEntity<Order> getOrderById(
        ...
        if(order.getUser().getId() == user.getId()) { // NOTE: in tutorial its .equals but it doesnt fit the data type so note incase it may come up 
            return ResponseEntity.ok(order);
        } else {
