...
import com.soniXchange.domain.WalletTransactionType;
...
import com.soniXchange.service.WithdrawalService;
...
public class WithdrawalController {
    ...
    public ResponseEntity<?> proceedWithdrawal(
        ...
        User user = userService.findUserProfileByJwt(jwt);
        Withdrawal withdrawal = withdrawalService.proceeWithwithdrawal(id, accept);
